...
export type MessageStatus = 'pending' | 'sent' | 'delivered' | 'read' | 'failed' | 'retrying';
 ...
 * ✅ 工具函数: 判断是否为协议消息
 */
export function isProtocolMessage(type: MessageType): boolean {
